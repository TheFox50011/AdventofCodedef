...
BASE DEL PROBLEMA
-------------------------------------------------------------------------------------------------------------------------------------
Este paquete contiene una solución en Java para un reto algorítmico de Advent basado en el análisis de una cuadrícula bidimensional (Grid).
...
-------------------------------------------------------------------------------------------------------------------------------------
El código utiliza un enfoque imperativo limpio, priorizando la legibilidad y la semántica 
del negocio sobre la implementación de bajo nivel.
-------------------------------------------------------------------------------------------------------------------------------------
-PATRONES CREACIONALES
-------------------------------------------------------------------------------------------------------------------------------------
*Static Factory Method: En `loadGrid`. Se mantiene el patrón de encapsular 
la lectura del archivo y la conversión a `List<String>`, ocultando la complejidad de E/S al consumidor.
--------------------------------------------------------------------------------------------------------------------------------------
...
*Clean Code - No Magic Numbers: El umbral de vecinos (4) y los caracteres especiales ('@') se han extraído a constantes 
...
PATRONES Y DISEÑOS UTILIZADOS
------------------------------------------------------------------------------------------------------------------------------------
Se estructura la solución para gestionar la mutabilidad del estado de forma controlada y segura.
...
-PRINCIPIOS DE DISEÑO
-------------------------------------------------------------------------------------------------------------------------------------
*OCP (Open/Closed Principle): El uso de la matriz `DIRECTIONS` hace que el código esté abierto a extensión (ej: cambiar a vecindad de Von Neumann de 4 direcciones) pero cerrado a modificación del algoritmo de conteo.
